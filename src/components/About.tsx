export default function AboutComponent() {
  return (
    <div className="flex w-full flex-col gap-10 bg-[#171921] p-20 text-[#fff]">
      <div>
      ...
      <div className="flex flex-wrap gap-14">
        ...
        <div className="min-w[200px] flex flex-1 flex-col justify-between gap-10">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex flex-col gap-2 text-center">
              <p className="text-6xl font-extrabold text-[#F0BB42] ">30</p>
              <p className="text-xl font-bold uppercase">Hours</p>
            </div>
            <div className="flex flex-col gap-2 text-center">
              <p className="text-6xl font-extrabold text-[#F0BB42]">12 K</p>
              <p className="text-xl font-bold uppercase">prize pool</p>
            </div>
            <div className="flex flex-col gap-2 text-center">
              <p className="text-6xl font-extrabold text-[#F0BB42]">28,29</p>
